...
export default tseslint.config(
  // Global ignores
  {
    ignores: [
      ...
      'tests/**',
      '**/.smoke-test/**',
      'shared/appkit-types/**', // generated by `appkit generate-types`
    ],
  },
  ...
  // Async event handlers (onClick/onSubmit) are idiomatic in React; allow them
  // while still catching misused promises elsewhere. Type-aware rule → TS files only.
  {
    files: ['**/*.ts', '**/*.tsx'],
    ignores: ['**/*.config.ts'],
    rules: {
